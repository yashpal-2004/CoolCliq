...
import { 
  Users, QrCode, MapPin, Menu, X, Bell, User, Settings
} from 'lucide-react';
        ...
        >
          <div className="space-y-6 flex flex-col items-center">
            <h1 className="text-[10px] font-black tracking-[0.4em] uppercase italic text-primary text-center px-4 animate-pulse">
              Ecosystem Connectivity: Network Optimization Active
            </h1>
              ...
              <div className="space-y-12">
                ...
                <nav className="space-y-1">
                  {[
                    ...
                    { label: 'Circles', icon: Users, path: '/mobile/circles', active: true },
